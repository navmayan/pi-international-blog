...
age <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\age\\age_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)

gender_science <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\gender_science\\gender_science_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)

race <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\race\\race_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)

sexuality <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\sexuality\\sexuality_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)

weight <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\weight\\weight_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)

skin <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\skin\\skin_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)

usa <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\usa\\usa_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)

# specific to israel
ethnic <- fread("C:\\Users\\Mayan Navon\\Google Drive\\School\\PhD\\Lab projects\\pi international data\\pi-international-demo-websites-data-processing\\Israel\\ethnicity\\ethnic_iat_wide_2009-2019.csv") %>% filter(year >= 2009 & year < 2020)
