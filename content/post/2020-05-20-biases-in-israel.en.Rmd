...
We found that *implicit bias* is robust and persistent: The IAT scores from all tasks revealed that Israelis **strongly** prefer  the dominant social groups (e.g., White people, Ashkenazi people, Young people) and not the non-dominant social groups (Black people, Mizrahi people, Old people).
...
We can see that, indeed, the implicit bias varies across the different ethnicities. Still, *all ethnicity groups* in the Israeli society show the same direction of bias.
