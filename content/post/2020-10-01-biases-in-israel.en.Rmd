...
Future studies could explore whether the extent of bias as measured with the IAT relates to the extent of real-world discrimination in Israel and to other negative treatment of disadvantaged groups.
...
We can see that, indeed, the IAT bias varies across the different ethnicities, and is weaker among Mizrahi Jews. Still, almost all ethnicity groups in our sample (including Mizrahi Jews) show the same direction of bias (pro-dominant). The only exception are Jews from Ethiopia. However, this group has a rather small sample (N = 25). Note that this data excludes non-Jewish participants.
